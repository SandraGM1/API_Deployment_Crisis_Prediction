...
def new_predict():
    try:
        ...
        return jsonify({
            "status": "Error",
            "message": "Predicción sobre nuevo archivo no se ha podido realizar, por favor, revisa el documento.",
            })
...
def new_retrain():
    try:
        ...
        return jsonify({
            ...
            "message": new_model["message"],
            "Balanced Accuracy" : new_model["Balanced Accuracy"]
            "ROC-AUC" : new_model["ROC-AUC"],
            "Class.Report" : new_model["Class.Report"],
            "Confusion_Matrix" : new_model["Confusion_Matrix"]
            })
    except:
        return jsonify({
            "status": "Error",
            "message": "Modelo no entrenado correctamente, por favor, revisa el documento."  
        })
